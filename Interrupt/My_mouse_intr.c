...
int init_module(void)    ///module initialization 
{
	...
	rv = request_irq(12, keyboard_handler, IRQF_SHARED, "Mouse_interrupt", &id); // this is interrupt resgistration inside that irq= its a interrupt number 
...
MODULE_AUTHOR ("Mr.Mandar Kamble  ");
